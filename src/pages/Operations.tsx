  ...
  const handleSaveOperation = (operationData: Operation) => {
    ...
    if (isNewOperation) {
      ...
      toast({
        ...
        description: "The operation was created successfully."
      });
    } else {
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className={cn(
        ...
        <main className="flex-1 px-6 py-6">
          ...
          {/* Active Operations */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Ongoing Operations</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">Start: {formatTime(operation.startTime)}</span>
                        </div>
                      </div>
                    </div>
              ...
              {filteredOperations.filter(op => op.status === 'active').length === 0 && (
                <div className="col-span-full p-8 text-center bg-card border rounded-lg">
                  <p className="text-muted-foreground">No operations in progress</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">Completed Operations</h2>
            <div className="bg-card rounded-lg shadow overflow-hidden">
              ...
              {filteredOperations.filter(op => op.status === 'completed').length === 0 && (
                <div className="p-8 text-center">
                  <p className="text-muted-foreground">No operations completed</p>
                </div>
              )}
            </div>
          </div>
