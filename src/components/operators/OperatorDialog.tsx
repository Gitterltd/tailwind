...
const OperatorDialog = ({ open, onOpenChange, operator, onSave }: OperatorDialogProps) => {
  ...
  const handleDateChange = (field: 'asoExpirationDate' | 'nrExpirationDate', date: Date | undefined) => {
    ...
    const statusField = field === 'asoExpirationDate' ? 'Status' : 'nrStatus';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `${formData.name} for ${isEditing ? 'updated' : 'Added'} successfully!`
    });
  };
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isEditing 
              ...
              : 'Fill in the new operators information in the fields below.'}
          </DialogDescription>
        </DialogHeader>
