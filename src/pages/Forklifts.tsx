...
const ForkliftsPage = () => {
  ...
  const handleDeleteForklift = (id: string) => {
    if (confirm("Are you sure you want to delete this forklift?")) {
      setForklifts(prev => prev.filter(f => f.id !== id));
      toast({
        title: "Forklift deleted",
        description: "The forklift has been deleted successfully."
      });
    }
  };
      ...
      <div className={cn(
        ...
        <main className="flex-1 px-6 py-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
              <h1 className="text-2xl font-bold">Forklift Management</h1>
              <p className="text-muted-foreground">Manage your forklift fleet</p>
            </div>
