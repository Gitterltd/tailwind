...
const GasSupplyPage = () => {
  ...
  const handleFilterToggle = () => {
    ...
    toast({
      title: "Filter",
      description: "This feature would allow for more advanced filters."
    });
  };
        ...
        <main className="flex-1 px-6 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-card border rounded-lg p-4 shadow">
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Total Supplies</h3>
            ...
            <div className="bg-card border rounded-lg p-4 shadow">
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Total Consumption (L)</h3>
              <div className="flex items-center justify-between">
            ...
            <div className="bg-card border rounded-lg p-4 shadow">
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Average per Filling (L)</h3>
              <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="space-y-2">
              <h4 className="text-sm font-medium">Fork-lift</h4>
              <select 
              ...
              <table className="w-full">
                <thead className="bg-muted/50">
                  <tr>
                    ...
                    <th className="p-4 text-left font-medium text-muted-foreground">Quantity (L)</th>
                    <th className="p-4 text-left font-medium text-muted-foreground">Initial Hour Meter</th>
                    <th className="p-4 text-left font-medium text-muted-foreground">Final Hour</th>
                    <th className="p-4 text-left font-medium text-muted-foreground">Operator</th>
                    <th className="p-4 text-left font-medium text-muted-foreground">Efficiency (L/h)</th>
